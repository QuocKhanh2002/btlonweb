...
mainForm.addEventListener("submit", (e) => {
  ...
  const addressProduct = document.getElementById("address-product").value;
  const emailProduct = document.getElementById("email-product").value;
  const ageProduct = document.getElementById("age-product").value;
...
function editProduct(index) {
  ...
  document.getElementById("address-product").value = Product.address;
  document.getElementById("email-product").value = Product.email;
  document.getElementById("age-product").value = Product.age;
